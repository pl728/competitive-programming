...
public class Main {
    ...
    static long something = 1000000000;
    ...
    public static void main(String[] args) {
        ...
        while(t-- != 0) {
            ...
            // increase the k smallest elements to 10^9

            // construct a graph with this new array
            // run floyd warshall on the graph to get shortest distance all pairs
            // get the max distance out of these pairs
