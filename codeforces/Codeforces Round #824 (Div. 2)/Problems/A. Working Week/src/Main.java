...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        while (tc-- != 0) {
            ...
            int y = x / 3;
            int b = 2 + 1 + y;
            int[] distances = new int[]{1, b - 3, n - b - 1};
            System.out.println(Math.min(Math.min(Math.abs(distances[1] - distances[0]), Math.abs(distances[2] - distances[0])), Math.abs(distances[1] - distances[0])));
        }
    }
