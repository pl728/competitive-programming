...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // to flip each bit manually, it takes two flips
        // we want to decrease this
        //
        // we can make it less in the case that j - i = 1
        // whenever we match '10' to '01' or match '01' to '10'
        // we can swap them for cost 1, saving 1 cost
        int ans = 0;
        for (int i = 1; i < n; i++) {
            if (c[i - 1] != d[i - 1]) {
