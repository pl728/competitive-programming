...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // find an optimal partition of the graph
        // GOAL: minimize the maximum size of the routing table for all routers in the network
        //

        for(int i = 0; i < M; i++) {
            int u = sc.ni(); int v = sc.ni(); int w = sc.ni();
            adjMatrix[u][v] = w;
        }
