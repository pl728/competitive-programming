...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        // two points cannot have the same x
        // two points cannot have the same y
        // two points cannot
        int numPoints = Math.min(n, m);
        System.out.println(numPoints + 1);
        for(int i = 0; i <= numPoints; i++) {
            System.out.println(i + " " + (numPoints - i));
        }
