    ...
    public static void main(String[] args) {
        ...
        if(zeros > ones + 1 || ones > zeros * 2 + 2) {
            ...
            if(ones == zeros - 1 || ones == zeros) {
                ...
                // we have a string of 1010101... consisting of 1 more one than zero
                int remaining = ones - (zeros + 1);
                boolean zero = false;
                int j = 0;
                for(int i = 0; i < (ones - remaining) + zeros; i++) {
                    if(zero) {
                        ans.append('0');
                    } else {
                        ans.append('1');
