...
//        int tc = sc.ni();
//        while (tc-- != 0) {
//            int n = sc.ni(), k = sc.ni(), r = sc.ni(), c = sc.ni();
//            char[][] fuckthiscontest = new char[n][n];
//            for(char[] row : fuckthiscontest) {
//                Arrays.fill(row, '.');
//            }
//            for(int i = 0; i < n; i++) {
//                for(int j = 0; j < n; j++) {
//                    if((i + j + 2) % k == (r + c) % k) {
//                        fuckthiscontest[i][j] = 'X';
//                    }
//                }
//            }
//            for(int i = 0; i < n;i ++) {
//                System.out.println(fuckthiscontest[i]);
//            }
//
//        }
        Scanner sc = new Scanner(System.in);
        while(true) {
            String i = sc.nextLine();String j = sc.nextLine();
