...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        int[] increasing = new int[duplicates];
        int[] decreasing = new int[n - duplicates];
        int i = 0; int j = 0;
        ...
        if (ans) {
            ...
            int[] decreasing_reverse = arrayUtils.reverse(decreasing);
            System.out.println(i);
            for(int k : increasing) {
                System.out.print(k + " ");
            }
            System.out.println();
            System.out.println(j);
            for(int k : decreasing_reverse) {
                System.out.print(k + " ");
            }
